    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <button type="submit" form="form-bank-transfer" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i>
                </button>
    ...
    <div class="container-fluid">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-pencil"></i> <img src="view/image/multibanco.png" alt="" /> <?php echo $heading_title; ?></h3>
            </div>
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-multibanco" class="form-horizontal">
                    <div class="form-group required">
                        <label class="col-sm-2 control-label" for="input-entidade"><span data-toggle="tooltip"><?php echo $entry_entidade; ?></span>
                        </label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group required">
                        <label class="col-sm-2 control-label" for="input-subentidade"><span data-toggle="tooltip"><?php echo $entry_subentidade; ?></span>
                        </label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group required">
                        <label class="col-sm-2 control-label" for="input-valorminimo"><span data-toggle="tooltip"><?php echo $entry_valorminimo; ?></span>
                        </label>
                        <div class="col-sm-10">
